...
using DtisCrudMVC.Models;

namespace DtisCrudMVC.Controllers
{
    public class ContatosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cpf,Email,Telefone")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cpf,Email,Telefone")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
